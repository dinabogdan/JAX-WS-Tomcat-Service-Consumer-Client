 ...
 * 
 */
@WebServiceClient(name = "WSImplementationService", targetNamespace = "http://services.ws.freesoft.com/", wsdlLocation = "http://localhost:8080/JAX-WS-Tomcat-Service/sayhello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLEMENTATIONSERVICE_QNAME = new QName("http://services.ws.freesoft.com/", "WSImplementationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JAX-WS-Tomcat-Service/sayhello?wsdl");
    ...
    public WSInterface getWSImplementationPort() {
        return super.getPort(new QName("http://services.ws.freesoft.com/", "WSImplementationPort"), WSInterface.class);
    }
    ...
    public WSInterface getWSImplementationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.ws.freesoft.com/", "WSImplementationPort"), WSInterface.class, features);
    }
